...
test-leetcode-00007:
	...
	@go test -v leetcode/00007_reverse_integer_test.go leetcode/00007_reverse_integer.go

test-leetcode-00048:
	@echo executing leetcode 00048 rotate image
	@go test -v leetcode/00048_rotate_image_test.go leetcode/00048_rotate_image.go

test-leetcode-00134:
	@echo executing leetcode 00134 gas station tests
	@go test -v leetcode/00134_gas_station_test.go leetcode/00134_gas_station.go

test-leetcode-00135:
	@echo executing leetcode 00135 candy tests
	@go test -v leetcode/00135_candy_test.go leetcode/00135_candy.go

test-leetcode-00279:
	@echo executing leetcode 00279 perfect squares
	@go test -v leetcode/00279_perfect_squares_test.go leetcode/00279_perfect_squares.go

test-leetcode-00376:
	@echo executing leetcode 00376 wiggle subsequence tests
	@go test -v leetcode/00376_wiggle_subsequence_test.go leetcode/00376_wiggle_subsequence.go

test-leetcode-00402:
	@echo executing leetcode 00402 remove k digits tests
	@go test -v leetcode/00402_remove_k_digits_test.go leetcode/00402_remove_k_digits.go

test-leetcode-00605:
	@echo executing leetcode 00605 can place flowers tests
	@go test -v leetcode/00605_can_place_flowers_test.go leetcode/00605_can_place_flowers.go
